#!/usr/bin/env bash
# 17-configured-p17-runner.sh — unmanaged protocol-22/current harness contract.
...
step "Dispatch configured harness through the protocol-22/current runner bridge"
